...
export default async function TrackingPage(props: {
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f8f7f2', color: '#1a1a1a', paddingTop: '100px', paddingBottom: '100px' }}>
            <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 24px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '40px', alignItems: 'start' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                        ...
                        {/* Status Card */}
                        <div style={{
                            background: 'linear-gradient(145deg, #ffffff 0%, #f3eee2 100%)',
                                    ...
                                    {tracking.activities.map((act: any, i: number) => (
                                        <div key={i} style={{
                                            ...
                                            <div style={{ flex: 1 }}>
                                                ...
                                                <div style={{ display: 'flex', gap: '12px', marginTop: '8px', fontSize: '10px', color: 'rgba(0,0,0,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        ...
                        {/* Courier Details */}
                        <div style={{ padding: '32px', background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.3)', borderRadius: '2px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                ...
                                {tracking?.etd && (
                                    <div style={{ marginTop: '8px', padding: '12px', background: 'rgba(212,175,55,0.1)', border: '1px solid rgba(212,175,55,0.3)', borderRadius: '4px' }}>
                        ...
                        {/* Destination */}
                        <div style={{ padding: '32px', background: '#ffffff', border: '1px solid rgba(0,0,0,0.05)', borderRadius: '2px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                {order.order_items.map((item: any, i: number) => (
                                    <div key={i} style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                                        <div style={{ width: '40px', height: '40px', background: '#f3eee2', borderRadius: '2px', overflow: 'hidden' }}>
