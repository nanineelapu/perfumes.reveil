    ...
    return (
        <div className="min-h-screen bg-white">
            <div className="max-w-[1400px] mx-auto px-6 py-12 lg:px-12 lg:py-20 space-y-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 text-black">
                    {[
                        ...
                        <div key={stat.label} className="group relative border-2 border-black p-12 hover:bg-black hover:text-white transition-all duration-500 cursor-default">
                            ...
                            <div className="absolute bottom-6 right-6 text-xs font-black opacity-5 group-hover:opacity-20 transition-opacity uppercase font-serif tracking-tighter text-black">REVEIL</div>
                        </div>
                    ))}
                </div>
                            ...
                            <thead>
                                <tr className="border-b-2 border-black text-black">
                                    {['Ref', 'Customer', 'Value', 'Status', 'Date'].map((h) => (
                                        <th key={h} className="px-8 py-6 text-[11px] font-black tracking-widest uppercase italic">
                                            {h}
                                        </th>
                                    ))}
                                </tr>
